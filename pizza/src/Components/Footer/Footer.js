        ...
        return(
            <footer className="footer">
                <div className="footer_item">
                    <Link to="/"><p className="footer_item_main">Arcobaleno's Pizza</p></Link>
                ...
                <div className="footer_item">
                    ...
                    <p className="footer_label">info@arcobalenos.ua</p>
                    <p className="footer_label">044 222 11 11</p>
                </div>
                <div className="footer_item">
                    <p className="footer_item_main">Arcobaleno's Pizza</p>
                    <p className="footer_label">© 2020 Arcobaleno's Pizza Украина</p>
